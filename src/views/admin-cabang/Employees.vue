        ...
        <table>
          ...
          <tbody>
            <tr v-for="emp in employees" :key="emp.id">
              ...
              <td class="actions">
                <button @click="openEdit(emp)" title="Edit">✏️</button>
                <button @click="handleToggle(emp.id)" title="Toggle Status">
                  ⏻
                </button>
                <button @click="handleDelete(emp.id)" title="Hapus">🗑</button>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="modal-box">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input v-model="form.position" placeholder="Jabatan" />
          </div>
